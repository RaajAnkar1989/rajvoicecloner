...
def bootstrap_repo_modules(monkeypatch):
    for name, path in [
        ("rajvoicecloner", SRC / "rajvoicecloner"),
        ("rajvoicecloner.model", SRC / "rajvoicecloner" / "model"),
        ("rajvoicecloner.modules", SRC / "rajvoicecloner" / "modules"),
    ]:
    ...
    internal_mods = {
        "rajvoicecloner.modules.audiovae": ["AudioVAE", "AudioVAEConfig", "AudioVAEV2", "AudioVAEConfigV2"],
        "rajvoicecloner.modules.layers": ["ScalarQuantizationLayer"],
        "rajvoicecloner.modules.locdit": ["CfmConfig", "UnifiedCFM", "RajVoiceClonerLocDiT", "RajVoiceClonerLocDiTV2"],
        "rajvoicecloner.modules.locenc": ["RajVoiceClonerLocEnc"],
        "rajvoicecloner.modules.minicpm4": ["MiniCPM4Config", "MiniCPMModel"],
        "rajvoicecloner.modules.layers.lora": ["apply_lora_to_named_linear_modules", "LoRALinear"],
    }
    ...
    _load_module("rajvoicecloner.model.utils", SRC / "rajvoicecloner" / "model" / "utils.py")
    rajvoicecloner = _load_module("rajvoicecloner.model.rajvoicecloner", SRC / "rajvoicecloner" / "model" / "rajvoicecloner.py")
    rajvoicecloner2 = _load_module("rajvoicecloner.model.rajvoicecloner2", SRC / "rajvoicecloner" / "model" / "rajvoicecloner2.py")
    return rajvoicecloner.RajVoiceClonerModel, rajvoicecloner2.RajVoiceCloner2Model
...
def test_load_lora_weights_accepts_tensor_only_legacy_checkpoints(monkeypatch, tmp_path, module_name):
    RajVoiceClonerModel, RajVoiceCloner2Model = bootstrap_repo_modules(monkeypatch)
    cls = RajVoiceClonerModel if module_name == "v1" else RajVoiceCloner2Model
