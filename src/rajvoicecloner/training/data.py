...
from ..model.rajvoicecloner import RajVoiceClonerConfig
...
class HFRajVoiceClonerDataset(TorchDataset):
    """
...
def build_dataloader(
    ...
    *,
    ...
    torch_dataset = HFRajVoiceClonerDataset(hf_dataset)
    ...
    return accelerator.prepare_dataloader(
        ...
        shuffle=True,
        collate_fn=HFRajVoiceClonerDataset.collate_fn,
        drop_last=drop_last,
    )
