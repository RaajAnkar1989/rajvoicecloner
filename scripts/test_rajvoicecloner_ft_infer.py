...
can be loaded directly via RajVoiceCloner.

Usage:

    python scripts/test_rajvoicecloner_ft_infer.py \
        --ckpt_dir /path/to/checkpoints/step_0001000 \
        --text "Hello, I am the finetuned RajVoiceCloner." \
        --output ft_test.wav
...
def parse_args():
    parser = argparse.ArgumentParser("RajVoiceCloner full-finetune inference test (no LoRA)")
    parser.add_argument(
        "--ckpt_dir",
        type=str,
        required=True,
