...
Loads src/rajvoicecloner/model/utils.py directly to avoid the heavy rajvoicecloner package
...
UTILS = str(REPO_ROOT / "src" / "rajvoicecloner" / "model" / "utils.py")
spec = importlib.util.spec_from_file_location("rajvoicecloner_utils", UTILS)
...
os.environ.pop("RAJVOICECLONER_MPS_DTYPE", None)
...
print("\n=== pick_runtime_dtype: RAJVOICECLONER_MPS_DTYPE override ===")
os.environ["RAJVOICECLONER_MPS_DTYPE"] = "bfloat16"
results.append(expect(pick_runtime_dtype("mps", "bfloat16"), "bfloat16", "override bf16 honored"))

os.environ["RAJVOICECLONER_MPS_DTYPE"] = "FP16"
results.append(expect(pick_runtime_dtype("mps", "bfloat16"), "fp16", "override is case-insensitive"))

os.environ["RAJVOICECLONER_MPS_DTYPE"] = "  float32  "
...
os.environ["RAJVOICECLONER_MPS_DTYPE"] = "half"
results.append(
    expect_raises(
...
os.environ["RAJVOICECLONER_MPS_DTYPE"] = "garbage"
results.append(
    expect_raises(
        lambda: pick_runtime_dtype("mps", "bfloat16"),
        ValueError,
